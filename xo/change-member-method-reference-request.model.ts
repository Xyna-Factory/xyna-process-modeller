 ...
 */
@XoObjectClass(XoRequest, 'xmcp.processmodeller.datatypes.request', 'ChangeMemberMethodReferenceRequest')
export class XoChangeMemberMethodReferenceRequest extends XoRequest {
