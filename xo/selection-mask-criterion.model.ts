...
@XoObjectClass(XoFormula, 'xmcp.processmodeller.datatypes', 'SelectionMaskItem')
export class XoSelectionMaskCriterion extends XoFormula {
    ...
    constructor(_ident?: string) {
        ...
        this.allowAsterisk = true;
        this.allowedFunctions = FormulaFunctionGroup.none;
    }
}


@XoArrayClass(XoSelectionMaskCriterion)
export class XoSelectionMaskCriterionArray extends XoArray<XoSelectionMaskCriterion> {
}
