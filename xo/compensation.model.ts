...
@XoObjectClass(XoModellingItem, 'xmcp.processmodeller.datatypes', 'Compensation')
export class XoCompensation extends XoModellingItem {
    ...
    @XoProperty()
    overriddenDefaultCompensation = false;
    ...
    afterDecode() {
        ...
        this.items = this.contentArea?.items?.data ?? [];
    }
}


@XoArrayClass(XoCompensation)
export class XoCompensationArray extends XoArray<XoCompensation> {
}
