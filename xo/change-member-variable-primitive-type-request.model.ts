 ...
 */
@XoObjectClass(XoRequest, 'xmcp.processmodeller.datatypes.request', 'ChangeMemberVariablePrimitiveTypeRequest')
export class XoChangeMemberVariablePrimitiveTypeRequest extends XoRequest {
