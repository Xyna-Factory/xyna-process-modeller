 ...
 */
@XoObjectClass(XoRequest, 'xmcp.processmodeller.datatypes.request', 'ChangeMemberVariableIsListRequest')
export class XoChangeMemberVariableIsListRequest extends XoRequest {
