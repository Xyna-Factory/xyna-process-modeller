...
@XoObjectClass(XoInsertFormulaRequest, 'xmcp.processmodeller.datatypes.request', 'InsertFilterCriterionRequest')
export class XoInsertFilterCriterionRequest extends XoInsertFormulaRequest {
    ...
    constructor(_ident?: string, index?: number, expression?: string, variables?: XoVariableArray<XoVariable>) {
        ...
        this.content.type = 'queryFilterCriterion';
    }
}
