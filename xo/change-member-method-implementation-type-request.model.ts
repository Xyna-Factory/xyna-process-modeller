 ...
 */
@XoObjectClass(XoRequest, 'xmcp.processmodeller.datatypes.request', 'ChangeMemberMethodImplementationTypeRequest')
export class XoChangeMemberMethodImplementationTypeRequest extends XoRequest {
