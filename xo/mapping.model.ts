...
* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
*/
import { XoContextMenuPlugin } from '@yggdrasil/plugin/context-menu-plugin.model';
...
export class XoMapping extends XoModellingItem {
    ...
    @XoProperty(XoContextMenuPlugin)
    plugin: XoContextMenuPlugin = new XoContextMenuPlugin();
