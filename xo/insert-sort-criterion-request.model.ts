...
@XoObjectClass(XoInsertFormulaRequest, 'xmcp.processmodeller.datatypes.request', 'InsertSortingCriterionRequest')
export class XoInsertSortingCriterionRequest extends XoInsertFormulaRequest {
    ...
    constructor(_ident?: string, index?: number, expression?: string, variables?: XoVariableArray<XoVariable>) {
        ...
        this.content.type = 'querySortCriterion';
    }
}
